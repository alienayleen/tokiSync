# ⚡️ TokiSync (토끼싱크) v1.9.41

**북토끼, 뉴토끼, 마나토끼**의 콘텐츠를 **구글 드라이브로 직접 업로드**하고, **전용 웹 뷰어**를 통해 편리하게 관리/열람할 수 있는 올인원 솔루션입니다.

> **🚀 v1.9.41 업데이트 요약:**
> **긴급 핫픽스 (DriveAccessService) 배포**: GAS 번들 파일(`TokiSync_Server_Bundle.gs`) 빌드 시 `DriveAccessService.gs` 누락으로 신규 설치 중 발생하던 `ReferenceError: DriveAccessService is not defined` 에러를 긴급 수정했습니다. 이전 v1.9.4의 지능형 제너릭 파서 고도화 및 광고 이미지 완전 격리 기능이 포함되어 있습니다.

---

## ✨ 주요 기능

### 📥 수집기 (UserScript) - v1.9.41
...
### 📊 뷰어 2.0 (Cinematic & Refined) - v1.9.41
