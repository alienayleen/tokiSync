# Graph Report - tokiSync  (2026-05-24)

## Corpus Check
- 142 files · ~171,757 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2687 nodes · 6078 edges · 158 communities (138 shown, 20 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 138 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4c9d99fc`
...
## Communities (158 total, 20 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.02
Nodes (130): _0, a0, ab, Ah, at, av, ay, _b (+122 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (26): am, Cp(), cr, dm, fd(), fm, hp, Ja() (+18 more)

### Community 2 - "Community 2"
Cohesion: 0.03
Nodes (84): Ad(), addKeys(), Ae, ag(), Ai(), Ar(), as(), bg (+76 more)
...
Cohesion: 0.05
Nodes (45): Ao(), Co(), Ct(), dd(), Ea(), El, Ep(), fa() (+37 more)
...
Cohesion: 0.09
Nodes (60): af, ba(), Dn(), Do(), du(), $e(), ef, er (+52 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (51): _a(), Al, An(), Be(), bf, bn(), _c, ca() (+43 more)
...
Cohesion: 0.07
Nodes (42): Ap(), bm, cm, cn(), Ee(), eh(), fi(), gm (+34 more)
...
Cohesion: 0.08
Nodes (25): b64urlDecode(), b64urlEncode(), checkInterval, chunk, chunkPromises, config, contentDoc, downloadedData (+17 more)
...
Cohesion: 0.12
Nodes (25): isAudioRunning(), startSilentAudio(), stopSilentAudio(), getConfig(), isConfigValid(), setConfig(), showConfigModal(), detectSite() (+17 more)

### Community 17 - "Community 17"
Cohesion: 0.09
Nodes (33): add(), addKey(), bh(), Cc, da(), ei, Es(), Fr (+25 more)
...
Cohesion: 0.1
Nodes (36): bd(), Bi(), Bs(), bt(), _d(), ff(), hn, If() (+28 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (5): aa(), Ii(), ml, pd(), xc

### Community 21 - "Community 21"
Cohesion: 0.11
Nodes (26): cs(), en(), fu(), ga(), gn(), hu(), Jn(), kr (+18 more)

### Community 22 - "Community 22"
Cohesion: 0.14
Nodes (26): arrayBufferToBase64(), checkInjection(), checkSingleHistoryDirect(), fetchHistory(), fetchHistoryDirect(), fetchImages(), fetchToken(), getBooksByCacheId() (+18 more)

### Community 23 - "Community 23"
Cohesion: 0.09
Nodes (17): extractEpisodeData(), checkInterval, chunk, chunkPromises, config, downloadedData, finalImages, result (+9 more)
...
Cohesion: 0.09
Nodes (23): code:bash (mkdir -p graphify-out), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash (graphify export wiki), code:bash (graphify export svg), code:bash (graphify export graphml), code:bash (graphify benchmark), code:bash ($(cat graphify-out/.graphify_python) -c "), code:block30 (Graph complete. Outputs in PATH_TO_DIR/graphify-out/) (+15 more)
...
Cohesion: 0.13
Nodes (5): closeActivePopup(), getImageDimensions(), MenuModal, stopSilentAudio(), TreeRuleEditor

### Community 36 - "Community 36"
Cohesion: 0.18
Nodes (5): fs(), le(), Rc, uu(), vf()
...
Cohesion: 0.09
Nodes (21): code:block1 (/graphify                                             # full), code:bash (if [ ! -f graphify-out/.graphify_python ]; then), code:bash (graphify cluster-only .), code:bash (graphify query "QUESTION"), code:bash ($(cat graphify-out/.graphify_python) -m graphify save-result), code:bash (graphify path "NODE_A" "NODE_B"), code:bash ($(cat graphify-out/.graphify_python) -m graphify save-result), code:bash ($(cat graphify-out/.graphify_python) -c ") (+13 more)
...
Cohesion: 0.1
Nodes (20): Changelog, 🚀 Direct Drive 업로드 안정화 및 자가 회복 로직 도입, 🐛 GAS 번들 빌더 누락 핫픽스 (DriveAccessService 해결), [v1.10.0] - 2026-05-18, [v1.1.3] - 2026-01-XX, [v1.7.2] - 2026-04-03, [v1.7.3] - 2026-04-08, [v1.7.3-hotfix] - 2026-04-09 (+12 more)
...
Cohesion: 0.18
Nodes (8): generateDownloadReport(), LogBox, markDownloadedItems(), Notifier, parseRangeSpec(), ParserFactory, saveFile(), tokiDownload()

### Community 44 - "Community 44"
Cohesion: 0.15
Nodes (18): ac(), Bo, bp(), dp, Go(), is, iu(), kp() (+10 more)
...
Cohesion: 0.14
Nodes (4): CbzBuilder, cleanNovelParagraphs(), EpubBuilder, TxtBuilder
...
Cohesion: 0.35
Nodes (13): b64urlDecode(), b64urlEncode(), fetchComicImages(), fetchMediaViaPopup(), fetchNovelText(), fetchNovelTextViaApi(), fetchNovelTextViaPopup(), getCookie() (+5 more)
...
Cohesion: 0.18
Nodes (10): 1-1. 프로젝트 생성 및 코드 복사, 1-2. appsscript.json 매니페스트 설정 (중요), 1-3. 🔒 보안(API Key) 및 배포, 1단계: Google Apps Script (서버) 설정, 2단계: UserScript (수집기) 설치, 3단계: 뷰어 (Viewer) 설정, code:json ({), TokiSync v1.8.3 설치 및 설정 가이드 (+2 more)
...
Cohesion: 0.22
Nodes (3): getDatabaseNames(), pa(), y0()
...
Cohesion: 0.67
Nodes (3): [v1.20.0] - 2026-05-24, 🔒 소설 복호화 API 시드 추출 방식 변경 및 디코딩 정제 고도화, 🏛️ 차세대 다형성 팝업 IPC 미디어 수집 엔진 및 보안 극복 시스템 안착
...
## Knowledge Gaps
- **772 isolated node(s):** `loaderMajor`, `requiredMajor`, `IGNORE_TAGS`, `KEEP_ATTRS`, `payload` (+767 more)
...
- **Why does `r()` connect `Community 19` to `Community 0`, `Community 1`, `Community 2`, `Community 4`, `Community 36`, `Community 7`, `Community 10`, `Community 44`, `Community 14`, `Community 17`, `Community 20`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `hr()` connect `Community 7` to `Community 0`, `Community 2`, `Community 4`, `Community 45`, `Community 14`, `Community 21`, `Community 29`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **Why does `tokiDownload()` connect `Community 3` to `Community 14`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
