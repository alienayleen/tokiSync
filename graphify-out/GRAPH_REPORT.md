# Graph Report - tokiSync  (2026-06-03)

## Corpus Check
- 149 files · ~194,182 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2966 nodes · 6847 edges · 163 communities (142 shown, 21 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 164 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `349fb2d2`
...
Cohesion: 0.02
Nodes (156): _0, a0, ab, Ah, at, au(), av, ay (+148 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (97): addKeys(), Ae, ag(), as(), bg, cd(), cg, ch() (+89 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (23): bm, cm, fd(), gm, ju(), ls(), Ns(), or (+15 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (61): a, activeWorkers, apply(), arrayBufferToBase64(), b64urlDecode(), b64urlEncode(), blob, builder (+53 more)
...
Cohesion: 0.07
Nodes (51): Ar(), Bs(), cs(), di(), ef, en(), fl(), fu() (+43 more)

### Community 8 - "Community 8"
Cohesion: 0.07
Nodes (48): _a(), Ad(), Al, Be(), bf, bn(), Cc, Ce() (+40 more)
...
Cohesion: 0.05
Nodes (22): aa(), Ai(), am, Ao(), bl(), Co(), da(), eh() (+14 more)

### Community 11 - "Community 11"
Cohesion: 0.08
Nodes (50): ba(), Bo, Dn(), Do(), Dr(), du(), er, eu() (+42 more)

### Community 12 - "Community 12"
Cohesion: 0.08
Nodes (5): fh(), Kn(), lh, uh, us()

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (24): CbzBuilder, EpubBuilder, extractEpisodeData(), blob, config, originalConsole, result, url (+16 more)
...
Cohesion: 0.09
Nodes (42): Ct(), ei, Ep(), Es(), fi(), fn, Fr, H() (+34 more)

### Community 16 - "Community 16"
Cohesion: 0.09
Nodes (39): af, An(), Bc(), bd(), Bi(), bt(), _c, ca() (+31 more)
...
Cohesion: 0.09
Nodes (5): LogBox, markDownloadedItems(), MenuModal, Notifier, TreeRuleEditor
...
Cohesion: 0.09
Nodes (43): 1. 📡 GAS 서버 배포, 2. 📥 UserScript (수집기) 설치, 3. 📊 뷰어 실행, ⚡️ TokiSync (토끼싱크) v1.10.0, ⚡️ TokiSync (토끼싱크) v1.20.5, ⚡️ TokiSync (토끼싱크) v1.21.3, ⚡️ TokiSync (토끼싱크) v1.21.5, ⚡️ TokiSync (토끼싱크) v1.22.0 (+35 more)

### Community 22 - "Community 22"
Cohesion: 0.12
Nodes (32): getConfig(), isConfigValid(), setConfig(), showConfigModal(), detectSite(), fetchImages(), generateDownloadReport(), parseRangeSpec() (+24 more)

### Community 23 - "Community 23"
Cohesion: 0.14
Nodes (30): checkSingleHistoryDirect(), closeActiveWorker(), extractEpisodeData(), fetchComicImages(), fetchHistory(), fetchHistoryDirect(), fetchImages(), fetchMediaViaPopup() (+22 more)
...
Cohesion: 0.09
Nodes (14): $e(), Hs(), ir(), Jn(), ko(), Lt(), mi(), mo (+6 more)

### Community 27 - "Community 27"
Cohesion: 0.1
Nodes (23): ac(), add(), addKey(), Ap(), bh(), dp, El, Go() (+15 more)
...
Cohesion: 0.1
Nodes (7): BaseParser, GenericParser, get(), markDownloadedItems(), parseRangeSpec(), ParserFactory, tokiDownload()

### Community 32 - "Community 32"
Cohesion: 0.2
Nodes (25): isAudioRunning(), startSilentAudio(), stopSilentAudio(), addEpisodesToQueue(), clearQueue(), closedCounts, getQueue(), getQueuePaused() (+17 more)

### Community 33 - "Community 33"
Cohesion: 0.1
Nodes (25): addEpisodesToQueue(), clearQueue(), closeActivePopup(), extractUrlEpisodeId(), findItem(), getImageDimensions(), getQueue(), getQueuePaused() (+17 more)

### Community 34 - "Community 34"
Cohesion: 0.16
Nodes (18): b64urlDecode(), b64urlEncode(), clearHandshakeTimeout(), closeActivePopup(), fetchComicImages(), fetchMediaViaPopup(), fetchMediaViaPopupSingleAttempt(), fetchNovelText() (+10 more)

### Community 35 - "Community 35"
Cohesion: 0.16
Nodes (22): activeBlobUrls, base64ToBytes(), cancelDownload(), cancelViewerDownload(), downloadBytesOnly(), downloadProgress, extractImages(), fetchAndUnzip() (+14 more)

### Community 36 - "Community 36"
Cohesion: 0.08
Nodes (24): 1. 규칙 스키마, 2.1 `meta` (작품 메타데이터), 2.2 `list` (에피소드 목록), 2.3 `viewer` (본문/이미지 추출), 2. 필드 명세, 3.1 헤드리스 이미지 추출 (`imageRegex`), 3.2 동적 LazyKey 탐지 (`keyDiscovery`) [v1.8.1], 3.3 동적 렌더링 대응 (`waitForSelector`) (+16 more)

### Community 38 - "Community 38"
Cohesion: 0.1
Nodes (24): 10.10. 레이지 로딩 고속화 (Hybrid Jump Engine - v1.7.4), 10.11. V1-Logic 기반 정밀 텍스트 렌더러 (Option A - v1.8.0), 10.4. 고성능 뷰어 엔진 (Virtual Scroll & UI Optimization), 10.5. Smart Double Spread (지능형 2쪽 보기), 10.6. Auto-Crop Margin Detection (자동 여백 제거), 10.7. Metadata Persistence & History Sync (v1.7.0 Final), 10.8. Viewer Stability Optimization (v1.7.0 Final), 10.9. v1.7.0 통합 엔진 최적화 및 안정화 (Final Specs) (+16 more)
...
Cohesion: 0.09
Nodes (22): Changelog, [v1.10.0] - 2026-05-18, [v1.1.3] - 2026-01-XX, [v1.20.6] - 2026-05-28, [v1.21.5] - 2026-06-01, [v1.22.0] - 2026-06-03, [v1.3.5] - 2026-02-06, [v1.7.3] - 2026-04-08 (+14 more)
...
Cohesion: 0.15
Nodes (5): getConfig(), isConfigValid(), LogBox, MenuModal, showConfigModal()
...
Cohesion: 0.11
Nodes (18): code:block1 (/graphify                                             # full), code:bash (if [ ! -f graphify-out/.graphify_python ]; then), code:bash (graphify cluster-only .), code:bash (graphify query "QUESTION"), code:bash ($(cat graphify-out/.graphify_python) -m graphify save-result), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash (python3 -m graphify.watch INPUT_PATH --debounce 3), code:bash (graphify hook install    # install) (+10 more)
...
Cohesion: 0.16
Nodes (14): EventBus, EVT, _listeners, sendToWorker(), activeWorkers, mockLogBox, mockLogs, mockUI (+6 more)
...
Cohesion: 0.12
Nodes (17): code:bash (mkdir -p graphify-out), code:bash ($(cat graphify-out/.graphify_python) -c "), code:bash (graphify export wiki), code:bash (graphify export svg), code:bash (graphify export graphml), code:bash (graphify benchmark), code:bash (# Detect the correct Python interpreter (handles uv tool, pi), code:bash (GRAPHIFY_WHISPER_MODEL=base  # or whatever --whisper-model t) (+9 more)
...
Cohesion: 0.18
Nodes (12): cn(), Ec, Ee(), il(), kl, nt, Oi, Pn() (+4 more)
...
Cohesion: 0.26
Nodes (8): gasConfig, getBaseUrl(), getBooks(), getChunk(), getLibrary(), getReadHistory(), request(), saveReadHistory()
...
Cohesion: 0.18
Nodes (10): 1. 트리 계층 구조도 (Hierarchy Map), 2.1 루트 및 기본 정보 (Basic Info), 2.2 메타 정보 (`meta`), 2.3 목록 설정 (`list`), 2.4 뷰어 설정 (`viewer`), 2. 노드별 상세 명세 (Node Specification), 3. 데이터 타입 가이드, 4. 트리 에디터(Tree Editor) 연동 규칙 (+2 more)
...
Cohesion: 0.2
Nodes (7): initWorkerExtractor(), initWorkerLogBox(), Notifier, sendToParent(), sendToWorker(), startSilentAudio(), startWorker()
...
## Knowledge Gaps
- **867 isolated node(s):** `loaderMajor`, `requiredMajor`, `IGNORE_TAGS`, `KEEP_ATTRS`, `payload` (+862 more)
...
- **Why does `a` connect `Community 15` to `Community 2`, `Community 44`, `Community 14`, `Community 7`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `r()` connect `Community 27` to `Community 0`, `Community 1`, `Community 2`, `Community 34`, `Community 7`, `Community 8`, `Community 10`, `Community 11`, `Community 44`, `Community 15`, `Community 16`, `Community 26`, `Community 60`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
- **Why does `tokiDownload()` connect `Community 4` to `Community 34`?**
  _High betweenness centrality (0.038) - this node is a cross-community bridge._
...
- **Are the 18 inferred relationships involving `H()` (e.g. with `pf` and `Gr()`) actually correct?**
