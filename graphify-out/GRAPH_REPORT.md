# Graph Report - tokiSync  (2026-05-14)

## Corpus Check
- 124 files · ~157,728 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2411 nodes · 5713 edges · 137 communities (118 shown, 19 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 118 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `53d0e5d1`
...
Cohesion: 0.02
Nodes (139): _0, a0, ab, Ah, as(), at, av, ay (+131 more)

### Community 1 - "Community 1"
Cohesion: 0.03
Nodes (108): addKeys(), Ae, ag(), Ai(), bg, bl(), Bo, bp() (+100 more)

### Community 2 - "Community 2"
Cohesion: 0.05
Nodes (12): ei, fh(), fs(), Jt, Kn(), le(), lh, qu() (+4 more)

### Community 3 - "Community 3"
Cohesion: 0.07
Nodes (67): af, Ar(), Bs(), cn(), cs(), Do(), $e(), Ee() (+59 more)
...
Cohesion: 0.07
Nodes (32): _c, ca(), Dr(), ef, ga(), gf, hi(), hr() (+24 more)

### Community 10 - "Community 10"
Cohesion: 0.1
Nodes (32): arrayBufferToBase64(), b64urlDecode(), checkInjection(), checkSingleHistoryDirect(), config, fetchHistory(), fetchHistoryDirect(), fetchImages() (+24 more)
...
Cohesion: 0.08
Nodes (37): ac(), bf, Bi(), bt(), ch(), cu(), di(), dp (+29 more)
...
Cohesion: 0.11
Nodes (38): add(), addKey(), am, au(), bh(), Ce(), df, dl() (+30 more)
...
Cohesion: 0.09
Nodes (28): _a(), Ad(), Al, cf(), ci, dh(), Ds, Ec (+20 more)
...
Cohesion: 0.14
Nodes (23): fetchImages(), generateDownloadReport(), parseRangeSpec(), processItem(), SLEEP_POLICIES, tokiDownload(), extractEpisodeData(), arrayBufferToBase64() (+15 more)
...
Cohesion: 0.13
Nodes (26): bd(), Be(), bn(), Co(), eh(), Ft(), fu(), gn() (+18 more)
...
Cohesion: 0.14
Nodes (25): An(), ba(), Cc, cl(), Dn(), du(), er, eu() (+17 more)

### Community 26 - "Community 26"
Cohesion: 0.1
Nodes (5): Ao(), Ii(), Io, ml, xc
...
Cohesion: 0.12
Nodes (18): aa(), Ap(), Bc(), en(), fi(), Hc(), he(), Ic() (+10 more)
...
Cohesion: 0.16
Nodes (16): bm, cm, Ct(), fd(), gm, or, qm, sg (+8 more)
...
Cohesion: 0.12
Nodes (9): TokiApiClient, b64urlEncode(), fetchNovelText(), getCookie(), getIdsFromUrl(), hmacSign(), resetNvCookie(), bridge (+1 more)
...
Cohesion: 0.11
Nodes (18): Antigravity Skill Bundles, Beginner → Intermediate → Advanced, code:bash (npx antigravity-awesome-skills), Contributing, 🎨 Creative & Content, 📊 Data & Analytics, Essentials & Core, 🎮 Game Development (+10 more)

### Community 43 - "Community 43"
Cohesion: 0.11
Nodes (17): Changelog, 🚀 Direct Drive 업로드 안정화 및 자가 회복 로직 도입, [v1.1.3] - 2026-01-XX, [v1.3.5] - 2026-02-06, [v1.7.2] - 2026-04-03, [v1.7.3] - 2026-04-08, [v1.7.3-hotfix] - 2026-04-09, [v1.7.4] - 2026-04-14 (+9 more)
...
Cohesion: 0.13
Nodes (14): 1. 📡 GAS 서버 배포, 2. 📥 UserScript (수집기) 설치, 3. 📊 뷰어 실행, ⚡️ TokiSync (토끼싱크) v1.8.3, ☁️ 다운로드, 📜 라이선스, 📂 문서 지도 (Documentation Map), 📊 뷰어 2.0 (Cinematic & Refined) - v1.8.3 (+6 more)
...
Cohesion: 0.13
Nodes (14): 1. 기본 구조, 2.1 Meta (작품 정보), 2.2 List (에피소드 목록), 2.3 Viewer (본문/이미지 추출), 2. 주요 필드 설명, 3.1 동적 렌더링 대응 (`waitForSelector`), 3.2 정규식 주의사항, 3.3 설정 적용 방법 (+6 more)
...
Cohesion: 0.18
Nodes (3): getDatabaseNames(), _p(), qo()
...
Cohesion: 0.27
Nodes (7): gasConfig, getBaseUrl(), getBooks(), getLibrary(), getReadHistory(), request(), saveReadHistory()
...
## Knowledge Gaps
- **621 isolated node(s):** `loaderMajor`, `requiredMajor`, `IGNORE_TAGS`, `KEEP_ATTRS`, `payload` (+616 more)
...
- **Why does `r()` connect `Community 15` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 37`, `Community 70`, `Community 39`, `Community 9`, `Community 13`, `Community 28`, `Community 17`, `Community 23`, `Community 25`, `Community 60`?**
  _High betweenness centrality (0.071) - this node is a cross-community bridge._
- **Why does `tokiDownload()` connect `Community 21` to `Community 18`, `Community 37`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `tokiDownload()` connect `Community 4` to `Community 37`?**
