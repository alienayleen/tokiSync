        ...
        <div class="relative w-full max-w-2xl bg-theme-surface border border-white/10 rounded-[32px] shadow-2xl overflow-hidden flex flex-col max-h-[90vh] transition-all duration-300 transform scale-100">
          ...
          <div class="px-8 py-6 border-b border-white/5 flex justify-between items-center bg-black/20">
            <div class="flex items-center space-x-3">
              ...
              <h2 class="text-xl font-black tracking-tight text-theme-text uppercase italic">Settings <span class="text-theme-accent font-normal not-italic ml-2 opacity-50 text-sm tracking-widest uppercase">v1.9.5</span></h2>
            </div>
            ...
            <transition name="fade-slide" mode="out-in">
              ...
              <div v-else-if="activeTab === 'viewer'" class="space-y-8 py-2">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div class="col-span-1 md:col-span-2 text-[9px] font-black text-theme-accent uppercase tracking-widest ml-1 mb-2">v1.9.5 Turbo Engine</div>
